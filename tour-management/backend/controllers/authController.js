...
await newUser.save()
res.status(200).json({success:true,message:"Successsully created"})

    }catch(err){
        res
        .status(200)
        .json({success:false,message:"Failed to create . Rey again"})
...
export const login=async(req,res)=>{
   ...
   //if user is exists xheck the passwords
